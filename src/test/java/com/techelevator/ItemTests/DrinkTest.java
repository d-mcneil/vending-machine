...
public class DrinkTest
{
    ...
    {
        Drink myDrink = new Drink("Mountain Melter", "Drink", new BigDecimal(3.55));
    ...
    {
        Drink myDrinkTest1 = new Drink("Mountain Melter", "Drink", new BigDecimal(3.55));
        Drink myDrinkTest2 = new Drink("7Down", "Drink", new BigDecimal(3.25));
        Drink myDrinkTest3 = new Drink("Papsi", "Drink", new BigDecimal(3.45));
