...
public class DisplayItemMenuTests {
    ...
    public void createInventoryManager() {
        ...
        inventoryLength = inventoryManager.getInventory().size();
    }
    ...
    @Test
    public void constructor_creates_menu_with_correct_values_when_product_quantity_reduced() {
    ...
    @Test
    public void constructor_creates_menu_with_correct_values_when_product_sold_out() {
        inventoryManager.dispenseInventory(inventoryManager.getInventory().get(0));
        inventoryManager.dispenseInventory(inventoryManager.getInventory().get(0));
        inventoryManager.dispenseInventory(inventoryManager.getInventory().get(0));
        inventoryManager.dispenseInventory(inventoryManager.getInventory().get(0));
